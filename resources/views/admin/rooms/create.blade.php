...
<div class="max-w-3xl mx-auto mt-10 bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200">
    <div class="px-6 py-8 md:px-10">
        <h2 class="text-3xl font-bold text-indigo-700 mb-8">Add New Room</h2>
        ...
        <form method="POST" action="{{ route('admin.rooms.store') }}" novalidate>
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label for="status" class="block text-sm font-medium text-gray-800 mb-1">Room Status</label>
